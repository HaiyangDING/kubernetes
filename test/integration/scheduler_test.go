...
func TestMultiScheduler(t *testing.T) {
	...
	*/
	...
	//		- testPodNoAnnotation, testPodWithAnnotationFitsDefault should be scheduled
	//		- testPodWithAnnotationFitsFoo should NOT be scheduled
	err = wait.Poll(time.Second, util.ForeverTestTimeout, podScheduled(restClient, testPodNoAnnotation.Namespace, testPodNoAnnotation.Name))
	if err != nil {
	...
	err = wait.Poll(time.Second, util.ForeverTestTimeout, podScheduled(restClient, testPodWithAnnotationFitsDefault.Namespace, testPodWithAnnotationFitsDefault.Name))
	if err != nil {
	...
	err = wait.Poll(time.Second, util.ForeverTestTimeout, podScheduled(restClient, testPodWithAnnotationFitsFoo.Namespace, testPodWithAnnotationFitsFoo.Name))
	if err == nil {
	...
	//	9. **check point-3**:
	//		- testPodNoAnnotation2 and testPodWithAnnotationFitsDefault2 shoule NOT be scheduled
	err = wait.Poll(time.Second, util.ForeverTestTimeout, podScheduled(restClient, testPodNoAnnotation2.Namespace, testPodNoAnnotation2.Name))
	if err == nil {
	...
	err = wait.Poll(time.Second, util.ForeverTestTimeout, podScheduled(restClient, testPodWithAnnotationFitsDefault2.Namespace, testPodWithAnnotationFitsDefault2.Name))
	if err == nil {
